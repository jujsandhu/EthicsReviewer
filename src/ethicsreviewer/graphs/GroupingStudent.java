...
public class GroupingStudent extends JFrame {

	private static final long serialVersionUID = 1L;

	public GroupingStudent(String applicationTitle, String chartTitle, ArrayList<JLabel> responses, String[] categoryNames, int qnum){
        ...
        for(JLabel response : responses)
        {
        	...
        	if(copy.getForeground().equals(Color.black))
        		assignTest(copy, aBox, bBox, cBox);
	...
	private void assignTest(JLabel response, JPanel aBox, JPanel bBox, JPanel cBox)
	{
    	...
    	if(category < 0.666 && category > 0.333)
    	{

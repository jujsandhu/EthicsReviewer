...
import ethicsreviewer.views.GraphView;
	...
	public class BarChart extends JFrame {
	     ...
	     */
	    public BarChart(String applicationTitle, String chartTitle, int qnum) {

	    	super(applicationTitle);
	        CategoryDataset dataset = createDataset(qnum);
	     ...
	     * @return The dataset.
	     */
	    private CategoryDataset createDataset(int qnum) {

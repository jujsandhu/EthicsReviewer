...
public class PieChartStudent extends JFrame {

  private static final long serialVersionUID = 1L;

  public PieChartStudent(String applicationTitle, String chartTitle, int qnum, int[] catcount) {
        super(applicationTitle);
        // This will create the dataset 
        PieDataset dataset = createDataset(qnum, catcount);
...
/**
    ...
    private  PieDataset createDataset(int qnum, int[] catcount) {
